/* regular expressions/ questions to be answered: */ 
 const q1 = /(din k(ai|e)saa?( (gu(j|z)ar|jaa?) ?rahaa?)? h(e|ai))|(k(e|ai|ay)s(aa?|i|ee) (feel|mehs(u|oo)s) kar rahi h(o|e|ai)n?)/i, 
   q2 = /(who('?re|( \b\w\b \b\w\b)? are) you)|((h(o|ai|e)n? k(o|au)n|k(o|au)n h(o|ai|e)n?) (tum?|aa?p))/i, 
   ...
   q17 = /^$/, 
   q18 = /(^calculator)|((open|a(ye|i)?sha?) ?(cal)?culator)|(\d+ ?(\+|-|(\*|x|×)|÷|(\/|\\)) ?\d+)|(calculate(?:bmi))/i, 
   q19 = 
   ...
   q44 = /((a(ye|i)?sha ?)?dict(ionary)?)|(ayesh ?nary)|(english ?(lafz k(i|a))? m(eaning|atlab))/i, 
   ...
   q59 = /(play save a(ye|i)?sha)|(^save a(ye|i)?sha( (play|chalaa?(o|na|(e|ai)n?)))?$)|((space|rock(et)?|meteor) game)/i, 
   q60 = 
   ...
   q68 = /(snap ?shots)|(landscapes)|((wall|a(ye|i)?sha?) ?papers?)|((kuch|some) (photos|pictures|images))/i, 
   ...
   q75 = /(giphy)|(a(ye|i)?sha? ?gifs)|(^gifs$)|((random|love|some) gifs)|(internet fun)/i, 
   q76 = 
   ...
   q85 = /((files?|images?|content) (compress|zip)((o|e)r|ion)?)|((win|7) ?(zip|rar))|((a(ye|i)?sha?)? ?(zipp|archiv)er)/i, 
   q86 = /((a(ye|i)?sha? ?)?ludo)|(board game)/i, 
   q87 = 
   ...
   q93 = /((I )?love (yo)?u)|((m(e|ai)n?|h(u|a)m) (aa?p|tum|tere) ?(ko|se|sa(y|i)) (chaha?t(aa?|a?i|e)|pyaa?r kart(aa?|i|e)) h(u|oo|e|ai)n?)|(you( a|')?re lovable)|(give me a rose)|(do you love me)|(ph(u|oo)l d((o|e|ai)n?|iji?y?e) ?(aa?p|tum|aa?(ye|i)?sha)? (mujh(e|a(i|y))|h(u|a)m(e|ai)n?))/i,
   ...
   q120 = /(time bataa?( d)?(o|e|ai|iy?e)n?)|(time( (bataa?o|a(ye|i)?sha))? kyaa? (((ho|baj) ?ra?haa?) ?)?h(e|ai))/i,
