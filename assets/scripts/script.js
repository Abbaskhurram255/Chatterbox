...
window.onload = () => {
 ...
 const random_speech = () => {
  ...
  let main_responses = ["music chaalane ka bolo to music chalaaoon?", "khabray? wo bhi mil ja'i gi. sirf news bolke tou dekhiye", "reminder set karna hey tou sirf reminders bolo or abhi set karo", "words translate karne hey tou sirf translate now bolo, or translation haasil karo", "dictionary bhi available hey", "apne shay'here ka mausam bolo tou wo bhi bataa sakti hu", "photo editor bhi available hey. Will be improved in the future.", "currency converter bhi available hey, jab chaaho ek currency se doosri currency ka exchange rate pataa karo", "youtube chalaane ke lee'yay bolo tou wo bhi chalaaoon?", "encyclopedia bhi available hey, jahaa aap ek ek cheez ki jaankaari paa sakte hey sirf oos ka naam likh kay. Kya cheez hey, kab kyu or kaisay bani. or kis ne banaaya. wagera, wagera", "Bank say lee'ya hua loan kaysay chukta hoga. ye tak bataa sakti hu may. sirf loan calculator likho tou", "strong password chaheeyay taakay koi bhi aapkay kisi bhi account ka password na tor sakay to abhi password generator likho, or. ek mazboot password haasil karo. . advice. is password ko ek acchi see jagaa save karke rakheeyay gaa taakay aap khud hee na bhool jaa'ay haha!", "life may behtree laane ki salaah chahte ho tou abhi advice generator bolo, or salaah haasil karo"];
  let arr = [];
